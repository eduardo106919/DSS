...
\begin{document}
	...
	\ucHeader{Nome do Use Case}
	{Descrição breve do Use Case}
	{Cenários em que o Use Case está presente}
	...
	\subFlowHeader{altOrange}{Fluxo Alternativo}{número}{condição que deu origem ao fluxo alternativo}
	\begin{flowtable}
		\step{}{-}{-}{-}
		\step{}{-}{-}{-}
	\end{flowtable}
	
	\subFlowHeader{excRed}{Fluxo de Exceção}{número}{condição que deu origem ao fluxo alternativo}
	\begin{flowtable}
		\step{}{-}{-}{-}
		\step{}{-}{-}{-}
	\end{flowtable}
	...
	\begin{flowtable}
		...
		\lstep{Actor selecciona instalação a realizar}
		\step{Sistema apresenta informação do pedido de instalação}{Consultar informação do pedido de instalação}{getPedido(codPedido : String) : Pedido}{Comercial}
		...
		\step{Sistema valida orientação e informa Actor de que esta é adequada}{Validar orientação e potência dos painéis}{validarPainel(ori : Orientacao, potencia : float, consumo : float) : boolean}{Tecnico}
		\lstep{Actor indica IPs do meter e da box}
		\step{Sistema regista as informações fornecidas no contrato}{Registar instalação de painéis}{registarInstalacao(nrContrato : String, meterIP : IP, boxIP : IP) : void}{Cliente}
		\step{Actor confirma o bom funcionamento da instalação}{Registar funcionamento da instalação}{registarFuncionamento(nrContrato : String, estado : boolean) : void}{Cliente}
	...
	\begin{flowtable}
		...
		\substep{Sistema regista novo contrato de energia}{Registar novo contrato de energia}{criarContrato(nrPedido : String) : void}{Cliente}
	...
	\begin{flowtable}
		...
		\substep{Sistema regista impossibilidade de acesso e adia instalação}{Registar impossibilidade de instalação}{registarImpossibilidade(nrPedido : String, motivo : String) : void}{Comercial}
	\end{flowtable}

	\subFlowHeader{excRed}{Fluxo de Exceção}{9}{ator indica mau funcionamento da instalação}
	\begin{flowtable}
		\substep{Sistema regista mau funcionamento da instalação}{Registar funcionamento da instalação}{registarFuncionamento(nrContrato : String, estado : boolean) : void}{Cliente}
	\end{flowtable}
